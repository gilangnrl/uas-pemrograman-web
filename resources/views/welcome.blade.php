...
<body>
    ...
    <div class="message-box">
        ...
        <p>Silahkan Untuk Login Atau Membuat Akun Baru</p>
        <div class="buttons-con">
            <div class="action-link-wrap">
                <a href="/login" class="link-button link-back-button">Login</a>
                <a href="/register" class="link-button">Register</a>
                <a href="/artikel" class="link-button">Artikel Seputar Kami</a>
            </div>
        </div>
    </div>
                        ...
                        <a href="">
                            <div class="news-detail-wrapper">
                                <img class="center-cropped"
                                    src="https://images.squarespace-cdn.com/content/v1/5bd82ac99b8fe8178d5bc6e9/1649124191068-UU7VN0N3BS34BVTCX59W/Bibit+LinkAja-1.jpg?format=2500w"
                                    alt="news img">
                            </div>
                            <div id="detail-title" class="news-detail">
                                <h1>{{$article->title}}</h1>
                                <div class="news-content">
                                    <div class="flex">
                                        <div class="author">
                                            <span>oleh: {{$article->users->name}}</span>
                                        </div>
                                        <div class="time-text">
                                            <div> Pada <span>{{$article->created_at}}</span></div>
                                        </div>
                                    </div>
                                </div>
                                <p>{{$article->body}}</p>
